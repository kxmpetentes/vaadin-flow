...
public class IndexHtmlRequestHandler extends JavaScriptBootstrapHandler {
  ...
  private static final List<DynamicMetadataListener> DYNAMIC_META_DATA_LISTENER = new ArrayList<>();

  public static void addRequestHandler(DynamicMetadataListener dynamicMetadataListener) {
    DYNAMIC_META_DATA_LISTENER.add(dynamicMetadataListener);
  }
  ...
  public boolean synchronizedHandleRequest(VaadinSession session,
    ...
    for (DynamicMetadataListener listener : DYNAMIC_META_DATA_LISTENER) {
      listener.updateDocument(indexDocument, request);
    }
