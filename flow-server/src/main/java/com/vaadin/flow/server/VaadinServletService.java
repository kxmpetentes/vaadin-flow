...
public class VaadinServletService extends VaadinService {
  ...
  /**
   * Creates a servlet service. This method is for use by dependency injection frameworks etc. {@link #getServlet()} and
   * {@link #getContext()} should be overridden (or otherwise intercepted) to not return <code>null</code>.
   */
  ...
  /**
   * Retrieves a reference to the servlet associated with this service. Should be overridden (or otherwise intercepted)
   * if the no-arg constructor is used to prevent NPEs.
   *
   ...
   *
   * @param path the path inside servlet context
   ...
   *
   * @param path the path inside servlet context, automatically translated as needed for webjars
   * @return a URL for the resource or <code>null</code> if no resource was found
   */
